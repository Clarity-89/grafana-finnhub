...
function (_super) {
  ...
  function DataSource(instanceSettings, backendSrv) {
    ...
    _this.token = config.apiToken;
    _this.baseUrl = "https://finnhub.io/api/v1";
    _this.websocketUrl = "wss://ws.finnhub.io?token=" + _this.token;
    return _this;
  }
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.backendSrv.get(this.baseUrl + "/" + query, {
              token: this.token
            })];
  ...
  DataSource.prototype.get = function (dataType, params) {
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            url = "" + this.baseUrl + (dataType === 'quote' ? '' : '/stock');
            _a.label = 1;
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , this.backendSrv.get(url + "/" + dataType, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, params), {
              token: this.token
            }))];
